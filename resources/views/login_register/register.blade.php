...
<div class="register-box">
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <p class="login-box-msg">Üyemiz Olun</p>
                    ...
                    <div class="col-8">
                        <div class="icheck-primary">
                            ...
                            <label for="agreeTerms">
                                 <a href="/sartlar">Şartları</a> okudum ve kabul ediyorum
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
            ...
            <a href="/giris" class="text-center">Zaten bir üyeliğiniz varsa tıklayın</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
